...
from openapi_server.models.option import Option  # noqa: E501
...
class OptionResults(Model):
    ...
    def __init__(self, option=None, total_votes_for=None, vote_proportion_percent=None):  # noqa: E501
        """OptionResults - a model defined in OpenAPI
    ...
    def total_votes_for(self, total_votes_for):
    ...
    @property
    def vote_proportion_percent(self):
    ...
    def vote_proportion_percent(self, vote_proportion_percent):
