...
class InlineResponse2007(Model):
    ...
    def __init__(self, verifier_password: str=None, voter_list: List[VotingUser]=None, election_info: Election=None):  # noqa: E501
        ...
        :param verifier_password: The verifier_password of this InlineResponse2007.  # noqa: E501
        :type verifier_password: str
        :param voter_list: The voter_list of this InlineResponse2007.  # noqa: E501
        :type voter_list: List[VotingUser]
        :param election_info: The election_info of this InlineResponse2007.  # noqa: E501
    ...
    def verifier_password(self) -> str:
        """Gets the verifier_password of this InlineResponse2007.
        ...
        :return: The verifier_password of this InlineResponse2007.
        :rtype: str
        """
    ...
    def verifier_password(self, verifier_password: str):
        """Sets the verifier_password of this InlineResponse2007.

        OPTIONAL. The password used by id verifiers to access the voting machine.  This will be present if the election is verified   # noqa: E501

        :param verifier_password: The verifier_password of this InlineResponse2007.
        :type verifier_password: str
        """
    ...
    def voter_list(self, voter_list: List[VotingUser]):
        """Sets the voter_list of this InlineResponse2007.

        The complete voter list. includes:: - First name - Last name - Organization id(if verified election) - voting_token   # noqa: E501

        :param voter_list: The voter_list of this InlineResponse2007.
        :type voter_list: List[VotingUser]
        """
    ...
    def election_info(self) -> Election:
        """Gets the election_info of this InlineResponse2007.


        :return: The election_info of this InlineResponse2007.
        :rtype: Election
        """
    ...
    def election_info(self, election_info: Election):
        """Sets the election_info of this InlineResponse2007.


        :param election_info: The election_info of this InlineResponse2007.
        :type election_info: Election
        """
