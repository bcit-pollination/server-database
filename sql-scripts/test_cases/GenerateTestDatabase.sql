...
CALL UpdatePrivilege(1, 2, 2);
CALL UpdatePrivilege(2, 2, 3);

CALL CreateElection(2, "Web Dev", CURRENT_TIMESTAMP(), TIMESTAMPADD(hour, 1, CURRENT_TIMESTAMP()), TRUE, TRUE, TRUE);
CALL CreateElection(1, "C Survey", CURRENT_TIMESTAMP(), TIMESTAMPADD(hour, 1, CURRENT_TIMESTAMP()), TRUE, FALSE, FALSE);
CALL UpdateElection(1, 'Web Dev Survey', CURRENT_TIMESTAMP(), TIMESTAMPADD(hour, 1, CURRENT_TIMESTAMP()), TRUE, FALSE, FALSE);
...
CALL UpdateOrg(1, "org name", "verifier password");
